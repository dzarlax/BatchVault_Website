...
const legalPages = {
  ...
  ru: {
    privacy: {
      ...
      lead: 'Здесь описано, какие данные BatchVault собирает через сайт, веб-приложение и мобильные приложения.',
      updated: 'Последнее обновление: 3 июня 2026.',
      contact: 'По вопросам приватности напишите через кнопку контакта ниже.',
      sections: [
        {
          title: 'Какие данные мы собираем',
          text: [
            'Когда вы используете BatchVault, мы можем хранить данные аккаунта, контакт, выбранный язык, технические данные устройства и материалы, которые вы добавляете в сервис.',
            'В эти материалы могут входить рецепты, ингредиенты, цены, продукты, заказы, клиенты, заметки и данные из пилотной или контактной формы.'
          ]
        },
        {
          title: 'Зачем мы их используем',
          text: [
            'Данные нужны для работы сервиса: чтобы сохранять ваши записи, считать цены, показывать заказы, отвечать на обращения и поддерживать связь.',
            'Технические данные помогают бороться со спамом, исправлять ошибки и поддерживать стабильную работу веб- и мобильных приложений.'
          ]
        },
        {
          title: 'Где они хранятся',
          text: [
            'Данные хранятся на серверах BatchVault и в рабочих базах, которые обеспечивают работу сервиса. Уведомления из контактных форм могут отправляться в Telegram-канал владельца проекта.',
        ...
        },
        {
          title: 'Ваши права',
          text: [
            'Вы можете запросить копию данных, исправление или удаление через кнопку контакта на этой странице.',
    ...
    'data-deletion': {
      ...
      lead: 'Если вы хотите удалить персональные данные или данные аккаунта из BatchVault, отправьте запрос.',
      ...
      sections: [
        {
          ...
          text: [
            ...
            'Если у вас есть аккаунт, укажите email аккаунта. Если вы отправляли только контактную форму, добавьте имя, тип продукта или короткое сообщение, чтобы мы могли найти запись.'
          ]
        },
        {
          ...
          text: [
            ...
            'Мы не удаляем анонимные технические логи, которые уже нельзя надежно связать с вами. Некоторые данные могут временно храниться, если это нужно для безопасности, расследования злоупотреблений или юридических причин.'
          ]
        },
        {
